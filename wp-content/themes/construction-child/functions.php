...
function construction_scripts() {
    ...
    wp_enqueue_style('select2',get_template_directory_uri(). '/content/css/libs/select2.css');
    ...
    wp_enqueue_script('select2',get_theme_file_uri('/content/js/libs/select2.js'));
