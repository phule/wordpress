 ...
 * Shop Section
 */
 $construciton_shop_section_title = get_theme_mod('construction_shop_title');
 $construciton_shop_section_sub_title = get_theme_mod('construction_shop_sub_title');
 ?>
<div class="ak-container">
    <?php if($construciton_shop_section_title || $construciton_shop_section_sub_title){ ?>
        <div class="section-title-sub-wrap wow fadeInUp">
            <?php if($construciton_shop_section_title){ ?><div class="section-title"><h5><?php echo esc_attr($construciton_shop_section_title); ?></h5></div><?php } ?>
            <?php if($construciton_shop_section_sub_title) { ?><div class="section-sub-title"><h2><?php echo esc_attr($construciton_shop_section_sub_title); ?></h2></div><?php } ?>
        </div>
    <?php } ?>
                    ...
                    <div class="product-info-wrap <?php if (empty($average)){echo 'no-rating';} ?>">
                        ...
                        <div class="rating-price clearfix">
                            ...
                            <div class="product-rating">
                                <?php if ($average) : ?>
                                    <?php echo '<div class="star-rating" title="'.sprintf(__( 'Rated %s out of 5', 'construction' ), $average).'"><span style="width:'.( ( $average / 5 ) * 100 ) . '%"><strong itemprop="ratingValue" class="rating">'.$average.'</strong> '.__( 'out of 5', 'construction' ).'</span></div>'; ?>
                                <?php endif; ?>
                            </div>
                        </div>
